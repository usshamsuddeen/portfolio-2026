...
export const projects: Project[] = [
  ...
  {
    id: "tech-enterprise-redesign",
    title: "Tech Enterprise Redesign",
    subtitle: "Enterprise Website Architecture",
    status: "ARCHIVED",
    statusColor: "#6B7280",
    repoName: "tech-enterprise-redesign",
    description: "A comprehensive project focused on the complete UI/UX modernization and architectural redesign of an enterprise website. Built to demonstrate high-fidelity interactions and modern web standards.",
    tags: ["Redesign", "UI/UX", "Architecture", "React", "Frontend"],
    thumbnail: "/github-alt.webp",
    links: [],
  },
  {
